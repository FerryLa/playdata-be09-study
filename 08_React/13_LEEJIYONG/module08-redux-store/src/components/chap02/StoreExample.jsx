...
- reducer를 feature(기능) 단위로 나누고,
  ...
  combineReducers > 여러 부서를 하나 총괄 시스템으로 통합
  */
...
/* 
  [Action]
  - Redux 에서 상태(state)를 변경하려면 'Action'이라는 신호를 보낸다.
...
// combineReducers 로 생성
const rootReducer = combineReducers({
  count: countReducer, // **> countReducer를 count라는 이름으로 저장하며 이는 state의 이름이 된다.
