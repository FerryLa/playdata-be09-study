...
console.log(target.match(/VA/)); // 대문자 VA가 없기 때문에 null
console.log(target.match(/VA/i));
console.log(target.match(/VA/gi));
...
console.log(/^https/.test(target)); // https로 시작하는지 확인, 따라서 true
console.log(/com$/.test(target)); // com으로 끝나는건지 확인, 따라서 true
// boolean 값으로 반환
