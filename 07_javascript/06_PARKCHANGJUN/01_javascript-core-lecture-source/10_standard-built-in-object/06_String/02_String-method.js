// 문자열은 변경 불가능한 원시 값이기 때문에 String 래퍼 객체로 읽기 전용 객체로 제공된다.
...
console.log("==============================");
// String.prototype.replace : 첫번째 인수로 전달 받은 문자열 또는 정규표현식을 검색하여 두번째 인수로 전달한 문자열로 치환한 문자열 반환
...
console.log("==============================");
// String.prototype.split : 첫번째 인수로 전달한 문자열 또는 정규식을 검색하여 문자열을 구분한 후 분리 된 각 문자열로 이루어진 배열 반환
