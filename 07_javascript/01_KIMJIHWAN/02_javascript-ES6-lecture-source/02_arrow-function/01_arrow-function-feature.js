// 화살표 함수 특징
// 화살표 함수는 기존의 함수보다 표현이 간략한 것 뿐만 아니라 내부 동작 또한
// 간략화 되어 있다.
...
const arrowFunc = () => {}; // TypeError: arrowFunc is not a constructor
...
// 상위스코프를 그대로 참조하도록 설계되어 ESS 콜백 함수에서 자주 발생하던
// this 바인딩 문제(전역 객체 or undefined를 가리킴)를 간편하게 해결 할 수 있다.